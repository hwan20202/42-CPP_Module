...
int main(void)
{
	...
	std::cout << "a is " << a.toInt() << " as integer" << std::endl<< std::endl;
	std::cout << "b is " << b.toInt() << " as integer" << std::endl<< std::endl;
	std::cout << "c is " << c.toInt() << " as integer" << std::endl<< std::endl;
